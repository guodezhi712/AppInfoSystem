	  ...
	  <p class="text-muted font-13 m-b-30"></p>
						...
						<tbody>
							<c:forEach var="appVersion" items="${appVersionList }" varStatus="status">
								<tr role="row" class="odd">
									...
									<td>
									<a href="down?images=${appVersion.apkFileName}">${appVersion.apkFileName }</a>
									</td>
        ...
        <form class="form-horizontal form-label-left" action="appversionmodifysave" method="post" enctype="multipart/form-data">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="number" min=0 max=500 step=1 id="versionSize" name="versionSize" value="${appVersion.versionSize }"  required="required"
