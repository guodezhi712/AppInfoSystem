	  ...
	  <!-- <div class="item form-group">
        ...
        <form class="form-horizontal form-label-left" action="appinfoaddsave" method="post" enctype="multipart/form-data">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            <!-- 软件大小输入只能是数字 -->
              <input type="number" min=0 max=5000 step=1 id="softwareSize" name="softwareSize"   required="required" onkeyup="value=value.replace(/[^\d]/g,'')"
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <!-- 软件大小输入只能是数字 -->
              <input type="number" min=0 max=5000 step=1 id="downloads" name="downloads"   required="required"
