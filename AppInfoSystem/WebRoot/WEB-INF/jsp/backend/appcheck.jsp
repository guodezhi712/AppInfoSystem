      ...
      <div class="x_content1">
        ...
        <form class="form-horizontal form-label-left">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="number" min=0 max=500 step=1 value="${appVersion.versionSize }" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
           ...
           <div class="item form-group">
            ...
            <c:choose> 
			  ...
			  <c:otherwise>   
			    ...
			    <input type="hidden" id="a" value="${appVersion.apkFileName}">
			    <a id="apk">下载</a>
			    </p>
			  </c:otherwise> 
            </c:choose> 
