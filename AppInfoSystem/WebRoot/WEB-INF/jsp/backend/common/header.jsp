              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> 用户管理 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${pageContext.request.contextPath }/backend/userList">后台用户管理</a></li>
                       <c:if test="${userSession.userType ==1}">
                      		<li><a href="${pageContext.request.contextPath }/backend/devUserList">开发者资质审核</a></li>
                      	<li><a href="${pageContext.request.contextPath }/backend/Useradd">注册用户</a></li>
                      </c:if>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-bug"></i> 基础数据维护 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                    <c:if test="${userSession.userType ==1}">
                      <li><a href="${pageContext.request.contextPath }/backend/dataDictionaryList">数据字典</a></li>
